...
public class RotateAndMoveCommand extends CommandBase
{
    ...
    public RotateAndMoveCommand(final Swerve s_Swerve, final float desiredRotation, final float moveSpeed) {
    ...
    public void execute() {
        ...
        if (Math.abs(error) < 0.5) {
            ...
            this.s_Swerve.drive(new Translation2d(this.moveSpeed, 0.0), -output, true, true);
        }
    }
