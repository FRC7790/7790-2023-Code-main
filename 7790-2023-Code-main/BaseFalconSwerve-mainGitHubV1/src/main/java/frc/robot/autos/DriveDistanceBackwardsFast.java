...
public class DriveDistanceBackwardsFast extends SequentialCommandGroup
{
    public DriveDistanceBackwardsFast(final Swerve s_Swerve, final double distance, final float rotation) {
        super(new Command[0]);
