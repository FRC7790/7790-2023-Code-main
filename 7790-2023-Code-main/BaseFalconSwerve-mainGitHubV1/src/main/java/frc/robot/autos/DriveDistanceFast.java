...
public class DriveDistanceFast extends SequentialCommandGroup
{
    public DriveDistanceFast(final Swerve s_Swerve, final double distance, final float rotation) {
        super(new Command[0]);
        final TrajectoryConfig config = new TrajectoryConfig(10.0, 10.0).setKinematics(Constants.Swerve.swerveKinematics);
